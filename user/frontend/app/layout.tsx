...
export const metadata: Metadata = {
  ...
  title: {
    default: "Buymium – Beli Akun Instagram Terpercaya di Indonesia",
    template: "%s | Buymium",
  },
  description:
    "Platform beli akun Instagram terverifikasi terpercaya di Indonesia. Harga terjangkau, pengiriman cepat, garansi 24 jam, dan kredensial terenkripsi.",
  keywords: [
    "beli akun instagram",
    "jual akun instagram",
  ...
  openGraph: {
    ...
    siteName: "Buymium",
    title: "Buymium – Beli Akun Instagram Terpercaya di Indonesia",
  ...
  twitter: {
    card: "summary",
    title: "Buymium – Beli Akun Instagram Terpercaya",
    description: "Platform beli akun Instagram terverifikasi terpercaya di Indonesia.",
